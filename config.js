...
const JerryAddonsConfig = new DefaultConfig("JerryAddons", "data/settings.json")
...
const config = new Settings("JerryAddons", JerryAddonsConfig, "data/ColorScheme.json", "&0&l[&c&lJerryAddons&0&l] §7§lBy §6§lILoveQoL")
.setPos(15, 15)
.setSize(70, 70)
.apply()
